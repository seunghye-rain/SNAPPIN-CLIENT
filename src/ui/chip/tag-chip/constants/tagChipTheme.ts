...
export const TAG_CHIP_THEME_BY_VARIANT: Record<TagChipVariant, ChipTheme> = {
  'neon': { chipClassName: 'bg-neon-white', labelClassName: 'text-black-9' },
  'gray': { chipClassName: 'bg-black-3', labelClassName: 'text-black-8' },
  'transparent': { chipClassName: 'bg-transparent border-[0.07rem] border-black-1', labelClassName: 'text-black-1' },
};