...
import { DetailLayout } from '@/app/photo-final/[id]/components/detail-layout/DetailLayout';
/*
TODO: 스프린트 때  to.. 승혜ㅎㅎㅎㅎ - 동희가
1. photo-final, reservation 분리할 필요가 있었을까??
- 왜냐하면 헤더 text 빼고는 사실 똑같은 것 같음(중복된 코드가 많음)

2. (분리한다면) 현재는 photo-final는 detail-layout , detail-row 를 사용 o, 하지만 reservation는 detail-layout , detail-row 를 사용 x
구조를 통일 시켜도 될듯!
