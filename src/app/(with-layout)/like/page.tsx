import LikePageContent from '@/app/(with-layout)/like/components/LikePageContent';
import Header from '@/app/(with-layout)/like/component/header/Header';
import LikeTabs from '@/app/(with-layout)/like/components/LikeTabs';
import { LIKE_TAB, type LikeTab } from '@/app/(with-layout)/like/constants/tab';
